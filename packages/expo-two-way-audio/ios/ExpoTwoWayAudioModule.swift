...
let ON_PLAYBACK_COMPLETE_EVENT_NAME = "onPlaybackComplete"
...
public class ExpoTwoWayAudioModule: Module {
    ...
    public func definition() -> ModuleDefinition {
        ...
        AsyncFunction("initialize") { () -> Bool in
            do {
                ...
                self.setupPlaybackCompleteCallback()
                return true
            } catch {
        ...
        Events([
            ...
            ON_PLAYBACK_COMPLETE_EVENT_NAME,
        ])
    }
    ...
    private func setupOutputAudioLevelCallback() {
        ...
        private func setupPlaybackCompleteCallback() {
        audioEngine?.onPlaybackCompleteCallback = { [weak self] in
            self?.sendEvent(
                ON_PLAYBACK_COMPLETE_EVENT_NAME,
                [
                    "data": true
