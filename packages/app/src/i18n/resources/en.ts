export const en = {
  ...
  workNotebook: {
    title: "Notebook",
    openBesideAccessibility: "Open work notebook beside this chat",
    descriptor: {
      session: "Session notebook",
      sessionWithTitle: "{{title}} · session notebook",
      tooltip: "Work notebook",
      tooltipWithTitle: "{{title}} work notebook",
    },
    eyebrow: "SESSION NOTEBOOK",
    intro: "The persistent working margin for this chat.",
    loading: "Loading the work stream…",
    refresh: "Refresh",
    unavailable: {
      title: "Notebook unavailable",
      updateHostTitle: "Work notebooks need a newer host",
      updateHostDescription:
        "Update and reconnect the Paseo daemon to use the notebook beside this chat.",
      connecting: "Connecting to the Paseo host…",
      reconnect: "Reconnect the Paseo host to load this session notebook.",
    },
    notices: {
      reconnecting: "Showing saved notebook data while the host reconnects.",
      archivedReadOnly: "This agent is archived. Its notebook is available read-only.",
    },
    sections: {
      pinned: "Pinned",
    ...
    empty: {
      pinned: "Pin a note or question to keep it in view.",
      openQuestions: "Questions stay here until you resolve them.",
      streamTitle: "A clear working margin",
      streamDescription: "Add a note or open question below. Every change remains in this stream.",
    },
    eventCount: "{{count}} events",
    composer: {
      note: "Note",
      question: "Question",
      notePlaceholder: "Keep a note in the work stream…",
      questionPlaceholder: "What still needs an answer?",
      noteAccessibility: "New notebook note",
      questionAccessibility: "New notebook question",
      add: "Add",
    },
    status: {
    ...
    events: {
      ...
      questionReopened: "Question reopened",
      itemPinned: "Item pinned",
      itemUnpinned: "Item unpinned",
      referencedItem: "Referenced item",
      linkCaptured: "Link captured",
      artifactObserved: "Artifact observed",
    },
    authors: {
      agent: "Agent",
      system: "Paseo",
    ...
    errors: {
      loadTitle: "The notebook could not be loaded",
      incompleteTitle: "The notebook stream is incomplete",
      inconsistentRevision: "The notebook changed while loading. Retry for a consistent stream.",
      noProgress: "The notebook stream stopped advancing while it loaded.",
      incompleteStream:
        "The complete notebook stream is required before it can be shown or edited.",
      unknown: "The notebook could not be loaded. Try again.",
      archived: "Archived notebooks are read-only.",
      agentNotFound: "This notebook's agent could not be found.",
      invalidTarget: "That notebook item is no longer available in its expected state.",
      hostUnavailable: "The Paseo host is unavailable.",
      loadBeforeWrite: "Load the notebook before writing to it.",
      conflict: "The notebook changed elsewhere. It has been refreshed; try again.",
    },
  },
  sessions: {
    title: "History",
