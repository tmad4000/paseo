export const en = {
  ...
  agentPanel: {
    stream: {
      tab: "Stream",
      title: "Alongside this chat",
      description: "Questions, decisions, responses and files. Latest first.",
      ...
      noPending: "Nothing waiting for a reply",
      noPendingDescription: "Past questions and outcomes are still in the full stream.",
      emptyTitle: "Your chat’s companion stream",
      emptyDescription:
        "Questions, approvals and final responses will appear here as the agent works.",
      backToChat: "Back to chat",
      retention:
        "Recent 50 moments and collected files. Capture begins with the host update; full context stays in Chat.",
      question: "Question",
      decision: "Decision",
      permission: "Permission request",
      open: "Awaiting a reply",
      reply_sent: "Reply sent · decision not verified",
      pendingStatus: "Awaiting your response",
      ...
      outcomeDescription: "Run status describes the turn, not verification of the task.",
      excerpt: "Excerpt. Full context is in Chat.",
      showLess: "Show less",
      read: "Read",
