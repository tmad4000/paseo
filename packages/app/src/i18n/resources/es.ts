...
export const es: TranslationResources = {
  ...
  agentPanel: {
    stream: {
      tab: "Flujo",
      title: "Junto a este chat",
      description: "Preguntas, decisiones, respuestas y archivos. Lo más reciente primero.",
      ...
      pending: "Necesita respuesta ({{count}})",
      noPending: "No hay respuestas pendientes",
      noPendingDescription: "Las preguntas y resultados anteriores siguen en el flujo completo.",
      emptyTitle: "El flujo que acompaña tu chat",
      emptyDescription:
        "Aquí aparecerán preguntas, aprobaciones y respuestas finales mientras trabaja el agente.",
      backToChat: "Volver al chat",
      retention:
        "Los últimos 50 momentos y archivos recopilados. Se registra desde la actualización del host; el contexto completo está en Chat.",
      question: "Pregunta",
      decision: "Decisión",
      permission: "Solicitud de permiso",
      open: "Esperando respuesta",
      reply_sent: "Respuesta enviada · decisión sin verificar",
      pendingStatus: "Esperando tu respuesta",
      allowed: "Respuesta aceptada",
      denied: "Rechazada",
      expired: "Ya no está pendiente",
      completed: "Turno terminado",
      failed: "Turno fallido",
      canceled: "Interrumpido",
      outcomeDescription: "El estado describe el turno, no verifica la tarea.",
      excerpt: "Extracto. El contexto completo está en Chat.",
