...
export const es: TranslationResources = {
  ...
  workNotebook: {
    title: "Cuaderno",
    openBesideAccessibility: "Abrir el cuaderno de trabajo junto a este chat",
    descriptor: {
      session: "Cuaderno de la sesión",
      sessionWithTitle: "{{title}} · cuaderno de la sesión",
      tooltip: "Cuaderno de trabajo",
      tooltipWithTitle: "Cuaderno de trabajo de {{title}}",
    },
    eyebrow: "CUADERNO DE LA SESIÓN",
    intro: "El margen de trabajo persistente de este chat.",
    loading: "Cargando el flujo de trabajo…",
    refresh: "Actualizar",
    unavailable: {
      title: "Cuaderno no disponible",
      updateHostTitle: "Los cuadernos de trabajo requieren un host más reciente",
      updateHostDescription:
        "Actualiza y vuelve a conectar el daemon de Paseo para usar el cuaderno junto a este chat.",
      connecting: "Conectando con el host de Paseo…",
      reconnect: "Vuelve a conectar el host de Paseo para cargar el cuaderno de esta sesión.",
    },
    notices: {
      reconnecting: "Se muestran los datos guardados mientras el host vuelve a conectarse.",
      archivedReadOnly: "Este agente está archivado. Su cuaderno está disponible en modo lectura.",
    },
    sections: {
      pinned: "Fijado",
    ...
    empty: {
      pinned: "Fija una nota o pregunta para mantenerla a la vista.",
      openQuestions: "Las preguntas permanecen aquí hasta que las resuelvas.",
      streamTitle: "Un margen de trabajo despejado",
      streamDescription:
        "Añade abajo una nota o pregunta abierta. Cada cambio queda en este flujo.",
    },
    eventCount: "{{count}} eventos",
    composer: {
      note: "Nota",
      question: "Pregunta",
      notePlaceholder: "Guarda una nota en el flujo de trabajo…",
      questionPlaceholder: "¿Qué sigue necesitando respuesta?",
      noteAccessibility: "Nueva nota del cuaderno",
      questionAccessibility: "Nueva pregunta del cuaderno",
      add: "Añadir",
    },
    status: {
      noteAdded: "Nota añadida",
      questionAdded: "Pregunta añadida",
      updated: "Cuaderno actualizado",
    },
    actions: {
      pin: "Fijar",
      unpin: "Desfijar",
    ...
    events: {
      note: "Nota",
      questionOpened: "Pregunta abierta",
      questionResolved: "Pregunta resuelta",
      questionReopened: "Pregunta reabierta",
      itemPinned: "Elemento fijado",
      itemUnpinned: "Elemento desfijado",
      referencedItem: "Elemento referido",
      linkCaptured: "Enlace capturado",
      artifactObserved: "Artefacto observado",
    },
    authors: {
      agent: "Agente",
      system: "Paseo",
    ...
    errors: {
      loadTitle: "No se pudo cargar el cuaderno",
      incompleteTitle: "El flujo del cuaderno está incompleto",
      inconsistentRevision:
        "El cuaderno cambió durante la carga. Reintenta para obtener un flujo coherente.",
      noProgress: "El flujo del cuaderno dejó de avanzar durante la carga.",
      incompleteStream: "Se necesita el flujo completo antes de mostrar o editar el cuaderno.",
      unknown: "No se pudo cargar el cuaderno. Inténtalo de nuevo.",
      archived: "Los cuadernos archivados son de solo lectura.",
      agentNotFound: "No se encontró el agente de este cuaderno.",
      invalidTarget: "Ese elemento ya no está disponible en el estado esperado.",
      hostUnavailable: "El host de Paseo no está disponible.",
      loadBeforeWrite: "Carga el cuaderno antes de escribir en él.",
      conflict: "El cuaderno cambió en otro lugar. Se actualizó; inténtalo de nuevo.",
    },
  },
  sessions: {
    title: "Historial",
