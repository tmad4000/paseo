...
export const zhCN: TranslationResources = {
  ...
  agentPanel: {
    stream: {
      ...
      pending: "需要回复（{{count}}）",
      noPending: "没有待回复的内容",
      noPendingDescription: "之前的问题和结果仍在完整动态中。",
      emptyTitle: "此聊天的伴随动态",
      emptyDescription: "智能体工作时，问题、审批和最终回复会出现在这里。",
      backToChat: "返回聊天",
      retention: "最近50条记录和收集的文件。主机更新后开始记录；完整上下文保留在聊天中。",
      question: "问题",
      decision: "决策",
      permission: "权限请求",
      open: "等待回复",
      reply_sent: "已发送回复 · 决策尚未验证",
      pendingStatus: "等待你的回复",
      allowed: "回复已接受",
      denied: "已拒绝",
      expired: "不再待处理",
      completed: "回合结束",
      failed: "回合失败",
      canceled: "已中断",
      outcomeDescription: "运行状态描述回合状态，并不代表任务已验证完成。",
      excerpt: "内容摘录。完整上下文在聊天中。",
      showLess: "收起",
      read: "阅读",
      replyInChat: "在聊天中回复",
      viewStream: "查看动态",
