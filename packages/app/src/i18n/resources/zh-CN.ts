...
export const zhCN: TranslationResources = {
  ...
  workNotebook: {
    title: "工作笔记",
    openBesideAccessibility: "在此聊天旁打开工作笔记",
    descriptor: {
      session: "会话笔记",
      sessionWithTitle: "{{title}} · 会话笔记",
      tooltip: "工作笔记",
      tooltipWithTitle: "{{title}} 的工作笔记",
    },
    eyebrow: "会话笔记",
    intro: "此聊天的持久工作区。",
    loading: "正在加载工作流…",
    ...
    unavailable: {
      title: "笔记不可用",
      updateHostTitle: "工作笔记需要更新版本的主机",
      updateHostDescription: "请更新并重新连接 Paseo 守护进程，以便在此聊天旁使用工作笔记。",
      connecting: "正在连接 Paseo 主机…",
      reconnect: "请重新连接 Paseo 主机以加载此会话笔记。",
    },
    notices: {
      reconnecting: "主机重新连接期间显示已保存的笔记数据。",
      archivedReadOnly: "此代理已归档，其笔记仅供阅读。",
    },
    sections: {
      pinned: "已置顶",
      openQuestions: "待解决问题",
    ...
    empty: {
      pinned: "置顶笔记或问题，以便随时查看。",
      openQuestions: "问题会留在这里，直到你将其解决。",
      streamTitle: "清爽的工作区",
      streamDescription: "在下方添加笔记或待解决问题。每次更改都会保留在此工作流中。",
    },
    eventCount: "{{count}} 个事件",
    composer: {
      note: "笔记",
      question: "问题",
      notePlaceholder: "在工作流中保留一条笔记…",
      questionPlaceholder: "还有什么需要回答？",
      noteAccessibility: "新建工作笔记",
      questionAccessibility: "新建笔记问题",
      add: "添加",
    },
    status: {
      noteAdded: "已添加笔记",
    ...
    events: {
      note: "笔记",
      questionOpened: "已提出问题",
      questionResolved: "问题已解决",
      questionReopened: "问题已重新打开",
      itemPinned: "项目已置顶",
      itemUnpinned: "项目已取消置顶",
      referencedItem: "引用的项目",
      linkCaptured: "已捕获链接",
      artifactObserved: "已发现成果物",
    },
    authors: {
      agent: "代理",
      system: "Paseo",
    ...
    errors: {
      loadTitle: "无法加载笔记",
      incompleteTitle: "笔记工作流不完整",
      inconsistentRevision: "加载期间笔记发生了变化。请重试以获得一致的工作流。",
      noProgress: "加载期间笔记工作流停止前进。",
      incompleteStream: "必须加载完整的笔记工作流后才能查看或编辑。",
      unknown: "无法加载笔记，请重试。",
      archived: "已归档的笔记仅供阅读。",
      agentNotFound: "找不到此笔记对应的代理。",
      invalidTarget: "该笔记项目已不再处于预期状态。",
      hostUnavailable: "Paseo 主机不可用。",
      loadBeforeWrite: "写入前请先加载笔记。",
      conflict: "笔记已在其他位置发生变化。已刷新，请重试。",
    },
  },
  sessions: {
    title: "历史",
