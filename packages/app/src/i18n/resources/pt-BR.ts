...
export const ptBR: TranslationResources = {
  ...
  agentPanel: {
    stream: {
      tab: "Fluxo",
      title: "Ao lado desta conversa",
      description: "Perguntas, decisões, respostas e arquivos. Mais recentes primeiro.",
      ...
      pending: "Precisa de resposta ({{count}})",
      noPending: "Nenhuma resposta pendente",
      noPendingDescription: "Perguntas e resultados anteriores continuam no fluxo completo.",
      emptyTitle: "O fluxo que acompanha sua conversa",
      emptyDescription:
        "Perguntas, aprovações e respostas finais aparecerão aqui enquanto o agente trabalha.",
      backToChat: "Voltar à conversa",
      retention:
        "Os últimos 50 momentos e arquivos coletados. O registro começa com a atualização do host; o contexto completo fica no Chat.",
      question: "Pergunta",
      decision: "Decisão",
      permission: "Pedido de permissão",
      open: "Aguardando resposta",
      reply_sent: "Resposta enviada · decisão não verificada",
      pendingStatus: "Aguardando sua resposta",
      allowed: "Resposta aceita",
      denied: "Recusada",
      expired: "Não está mais pendente",
      completed: "Turno encerrado",
      failed: "Falha no turno",
      canceled: "Interrompido",
      outcomeDescription: "O estado descreve o turno, sem verificar a conclusão da tarefa.",
      excerpt: "Trecho. O contexto completo está no Chat.",
