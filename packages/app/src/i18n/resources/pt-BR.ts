...
export const ptBR: TranslationResources = {
  ...
  workNotebook: {
    title: "Caderno",
    openBesideAccessibility: "Abrir o caderno de trabalho ao lado desta conversa",
    descriptor: {
      session: "Caderno da sessão",
      sessionWithTitle: "{{title}} · caderno da sessão",
      tooltip: "Caderno de trabalho",
      tooltipWithTitle: "Caderno de trabalho de {{title}}",
    },
    eyebrow: "CADERNO DA SESSÃO",
    intro: "A margem de trabalho persistente desta conversa.",
    loading: "Carregando o fluxo de trabalho…",
    refresh: "Atualizar",
    unavailable: {
      title: "Caderno indisponível",
      updateHostTitle: "Os cadernos de trabalho precisam de um host mais recente",
      updateHostDescription:
        "Atualize e reconecte o daemon do Paseo para usar o caderno ao lado desta conversa.",
      connecting: "Conectando ao host do Paseo…",
      reconnect: "Reconecte o host do Paseo para carregar o caderno desta sessão.",
    },
    notices: {
      reconnecting: "Exibindo os dados salvos do caderno enquanto o host se reconecta.",
      archivedReadOnly:
        "Este agente está arquivado. O caderno está disponível somente para leitura.",
    },
    sections: {
      pinned: "Fixados",
    ...
    empty: {
      pinned: "Fixe uma nota ou pergunta para mantê-la visível.",
      openQuestions: "As perguntas permanecem aqui até serem resolvidas.",
      streamTitle: "Uma margem de trabalho limpa",
      streamDescription:
        "Adicione uma nota ou pergunta abaixo. Cada alteração permanece neste fluxo.",
    },
    eventCount: "{{count}} eventos",
    composer: {
      note: "Nota",
      question: "Pergunta",
      notePlaceholder: "Guarde uma nota no fluxo de trabalho…",
      questionPlaceholder: "O que ainda precisa de resposta?",
      noteAccessibility: "Nova nota do caderno",
      questionAccessibility: "Nova pergunta do caderno",
      add: "Adicionar",
    },
    status: {
      noteAdded: "Nota adicionada",
      questionAdded: "Pergunta adicionada",
      updated: "Caderno atualizado",
    },
    actions: {
      pin: "Fixar",
      unpin: "Desafixar",
      resolve: "Resolver",
      reopen: "Reabrir",
      openLink: "Abrir link {{url}}",
      openArtifact: "Abrir",
    },
    events: {
      note: "Nota",
      questionOpened: "Pergunta aberta",
      questionResolved: "Pergunta resolvida",
      questionReopened: "Pergunta reaberta",
      itemPinned: "Item fixado",
      itemUnpinned: "Item desafixado",
      referencedItem: "Item referenciado",
      linkCaptured: "Link capturado",
      artifactObserved: "Artefato observado",
    },
    authors: {
      agent: "Agente",
      system: "Paseo",
    ...
    errors: {
      loadTitle: "Não foi possível carregar o caderno",
      incompleteTitle: "O fluxo do caderno está incompleto",
      inconsistentRevision:
        "O caderno mudou durante o carregamento. Tente novamente para obter um fluxo consistente.",
      noProgress: "O fluxo do caderno parou de avançar durante o carregamento.",
      incompleteStream: "O fluxo completo é necessário antes de exibir ou editar o caderno.",
      unknown: "Não foi possível carregar o caderno. Tente novamente.",
      archived: "Cadernos arquivados são somente para leitura.",
      agentNotFound: "O agente deste caderno não foi encontrado.",
      invalidTarget: "Esse item não está mais disponível no estado esperado.",
      hostUnavailable: "O host do Paseo não está disponível.",
      loadBeforeWrite: "Carregue o caderno antes de escrever nele.",
      conflict: "O caderno mudou em outro lugar. Ele foi atualizado; tente novamente.",
    },
  },
  sessions: {
