...
export const ru: TranslationResources = {
  ...
  agentPanel: {
    stream: {
      ...
      noPending: "Нет вопросов без ответа",
      noPendingDescription: "Предыдущие вопросы и результаты доступны в полной ленте.",
      emptyTitle: "Лента вашего чата",
      emptyDescription: "Здесь появятся вопросы, запросы разрешений и итоговые ответы агента.",
      backToChat: "Вернуться в чат",
      retention:
        "Последние 50 событий и собранные файлы. Запись начинается после обновления хоста; полный контекст остаётся в чате.",
      question: "Вопрос",
      decision: "Решение",
      permission: "Запрос разрешения",
      open: "Ожидает ответа",
      reply_sent: "Ответ отправлен · решение не проверено",
      pendingStatus: "Ожидается ваш ответ",
      allowed: "Ответ принят",
      denied: "Отклонено",
      expired: "Больше не ожидает ответа",
      completed: "Ход завершён",
      failed: "Ошибка выполнения",
      canceled: "Прервано",
      outcomeDescription: "Статус описывает ход выполнения, а не подтверждает результат задачи.",
      excerpt: "Отрывок. Полный контекст — в чате.",
      showLess: "Свернуть",
      read: "Читать",
  ...
  realtimeVoice: {
    ...
    actions: {
      ...
      stop: "Завершить голосовой сеанс",
    },
  },
  rewind: {
