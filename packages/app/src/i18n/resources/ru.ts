...
export const ru: TranslationResources = {
  ...
  workNotebook: {
    title: "Блокнот",
    openBesideAccessibility: "Открыть рабочий блокнот рядом с этим чатом",
    descriptor: {
      session: "Блокнот сеанса",
      sessionWithTitle: "{{title}} · блокнот сеанса",
      tooltip: "Рабочий блокнот",
      tooltipWithTitle: "Рабочий блокнот {{title}}",
    },
    eyebrow: "БЛОКНОТ СЕАНСА",
    intro: "Постоянное рабочее поле этого чата.",
    loading: "Загрузка рабочего потока…",
    refresh: "Обновить",
    unavailable: {
      title: "Блокнот недоступен",
      updateHostTitle: "Для рабочих блокнотов нужен более новый хост",
      updateHostDescription:
        "Обновите и переподключите демон Paseo, чтобы использовать блокнот рядом с этим чатом.",
      connecting: "Подключение к хосту Paseo…",
      reconnect: "Переподключите хост Paseo, чтобы загрузить блокнот этого сеанса.",
    },
    notices: {
      reconnecting: "Показаны сохранённые данные блокнота, пока хост переподключается.",
      archivedReadOnly: "Этот агент архивирован. Его блокнот доступен только для чтения.",
    },
    sections: {
      pinned: "Закреплённое",
    ...
    empty: {
      pinned: "Закрепите заметку или вопрос, чтобы оставить их на виду.",
      openQuestions: "Вопросы остаются здесь, пока вы их не решите.",
      streamTitle: "Чистое рабочее поле",
      streamDescription:
        "Добавьте ниже заметку или открытый вопрос. Все изменения останутся в этом потоке.",
    },
    eventCount: "Событий: {{count}}",
    composer: {
      note: "Заметка",
      question: "Вопрос",
      notePlaceholder: "Сохраните заметку в рабочем потоке…",
      questionPlaceholder: "Что ещё требует ответа?",
      noteAccessibility: "Новая заметка в блокноте",
      questionAccessibility: "Новый вопрос в блокноте",
      add: "Добавить",
    },
    status: {
      noteAdded: "Заметка добавлена",
      questionAdded: "Вопрос добавлен",
      updated: "Блокнот обновлён",
    },
    actions: {
      pin: "Закрепить",
      unpin: "Открепить",
      ...
      openLink: "Открыть ссылку {{url}}",
      openArtifact: "Открыть",
    },
    events: {
      note: "Заметка",
      questionOpened: "Вопрос открыт",
      questionResolved: "Вопрос решён",
      questionReopened: "Вопрос открыт снова",
      itemPinned: "Элемент закреплён",
      itemUnpinned: "Элемент откреплён",
      referencedItem: "Связанный элемент",
      linkCaptured: "Ссылка сохранена",
      artifactObserved: "Артефакт обнаружен",
    },
    authors: {
      agent: "Агент",
      system: "Paseo",
    ...
    errors: {
      loadTitle: "Не удалось загрузить блокнот",
      incompleteTitle: "Поток блокнота неполон",
      inconsistentRevision:
        "Блокнот изменился во время загрузки. Повторите попытку для согласованного потока.",
      noProgress: "Поток блокнота перестал продвигаться во время загрузки.",
      incompleteStream: "Перед просмотром или редактированием необходимо загрузить весь поток.",
      unknown: "Не удалось загрузить блокнот. Повторите попытку.",
      archived: "Архивные блокноты доступны только для чтения.",
      agentNotFound: "Не удалось найти агента этого блокнота.",
      invalidTarget: "Этот элемент больше недоступен в ожидаемом состоянии.",
      hostUnavailable: "Хост Paseo недоступен.",
      loadBeforeWrite: "Загрузите блокнот перед записью.",
      conflict: "Блокнот изменился в другом месте. Он обновлён; повторите попытку.",
    },
  },
  sessions: {
    title: "История",
