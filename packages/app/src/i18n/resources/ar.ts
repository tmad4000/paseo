...
export const ar: TranslationResources = {
  ...
  agentPanel: {
    stream: {
      ...
      noPending: "لا شيء ينتظر الرد",
      noPendingDescription: "تظل الأسئلة والنتائج السابقة في الموجز الكامل.",
      emptyTitle: "موجز يرافق محادثتك",
      emptyDescription: "ستظهر الأسئلة والموافقات والردود النهائية هنا أثناء عمل الوكيل.",
      backToChat: "العودة إلى المحادثة",
      retention:
        "آخر 50 حدثاً والملفات المجمّعة. يبدأ التسجيل بعد تحديث المضيف؛ يبقى السياق الكامل في المحادثة.",
      question: "سؤال",
      decision: "قرار",
      permission: "طلب إذن",
      open: "بانتظار الرد",
      reply_sent: "أُرسل الرد · القرار غير متحقق منه",
      pendingStatus: "بانتظار ردك",
      allowed: "قُبل الرد",
      denied: "رُفض",
      expired: "لم يعد معلّقاً",
      completed: "انتهت الجولة",
      failed: "فشلت الجولة",
      canceled: "تمت المقاطعة",
      outcomeDescription: "تصف الحالة جولة التنفيذ ولا تؤكد إنجاز المهمة.",
      excerpt: "مقتطف. السياق الكامل في المحادثة.",
      showLess: "عرض أقل",
      read: "قراءة",
