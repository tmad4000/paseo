...
export const ar: TranslationResources = {
  ...
  workNotebook: {
    ...
    openBesideAccessibility: "فتح دفتر العمل بجانب هذه المحادثة",
    descriptor: {
      session: "دفتر الجلسة",
      sessionWithTitle: "{{title}} · دفتر الجلسة",
      tooltip: "دفتر العمل",
      tooltipWithTitle: "دفتر عمل {{title}}",
    },
    eyebrow: "دفتر الجلسة",
    intro: "مساحة عمل دائمة لهذه المحادثة.",
    loading: "جارٍ تحميل سجل العمل…",
    refresh: "تحديث",
    unavailable: {
      title: "دفتر الملاحظات غير متاح",
      updateHostTitle: "تتطلب دفاتر العمل مضيفًا أحدث",
      updateHostDescription:
        "حدّث برنامج Paseo وأعد الاتصال لاستخدام دفتر الملاحظات بجانب هذه المحادثة.",
      connecting: "جارٍ الاتصال بمضيف Paseo…",
      reconnect: "أعد الاتصال بمضيف Paseo لتحميل دفتر هذه الجلسة.",
    },
    notices: {
      reconnecting: "يتم عرض بيانات دفتر الملاحظات المحفوظة أثناء إعادة اتصال المضيف.",
      archivedReadOnly: "هذا الوكيل مؤرشف. دفتر ملاحظاته متاح للقراءة فقط.",
    },
    sections: {
      pinned: "المثبّت",
    ...
    empty: {
      pinned: "ثبّت ملاحظة أو سؤالًا لإبقائه ظاهرًا.",
      openQuestions: "تبقى الأسئلة هنا حتى تحلّها.",
      streamTitle: "مساحة عمل واضحة",
      streamDescription: "أضف ملاحظة أو سؤالًا مفتوحًا أدناه. يبقى كل تغيير في هذا السجل.",
    },
    eventCount: "{{count}} من الأحداث",
    composer: {
      note: "ملاحظة",
      question: "سؤال",
      notePlaceholder: "احتفظ بملاحظة في سجل العمل…",
      questionPlaceholder: "ما الذي لا يزال يحتاج إلى إجابة؟",
      noteAccessibility: "ملاحظة جديدة في الدفتر",
      questionAccessibility: "سؤال جديد في الدفتر",
      add: "إضافة",
    },
    status: {
      noteAdded: "تمت إضافة الملاحظة",
      questionAdded: "تمت إضافة السؤال",
      updated: "تم تحديث دفتر الملاحظات",
    },
    actions: {
      pin: "تثبيت",
      unpin: "إلغاء التثبيت",
    ...
    events: {
      note: "ملاحظة",
      questionOpened: "تم فتح سؤال",
      questionResolved: "تم حل السؤال",
      questionReopened: "أُعيد فتح السؤال",
      itemPinned: "تم تثبيت العنصر",
      itemUnpinned: "تم إلغاء تثبيت العنصر",
      referencedItem: "العنصر المشار إليه",
      linkCaptured: "تم التقاط الرابط",
      artifactObserved: "تم رصد الملف",
    },
    authors: {
      agent: "الوكيل",
      system: "Paseo",
    ...
    errors: {
      loadTitle: "تعذّر تحميل دفتر الملاحظات",
      incompleteTitle: "سجل دفتر الملاحظات غير مكتمل",
      inconsistentRevision: "تغيّر دفتر الملاحظات أثناء التحميل. أعد المحاولة لعرض سجل متسق.",
      noProgress: "توقف سجل دفتر الملاحظات عن التقدم أثناء التحميل.",
      incompleteStream: "يجب تحميل السجل الكامل قبل عرضه أو تعديله.",
      unknown: "تعذّر تحميل دفتر الملاحظات. حاول مرة أخرى.",
      archived: "دفاتر الملاحظات المؤرشفة للقراءة فقط.",
      agentNotFound: "تعذّر العثور على وكيل دفتر الملاحظات هذا.",
      invalidTarget: "لم يعد عنصر دفتر الملاحظات هذا متاحًا في حالته المتوقعة.",
      hostUnavailable: "مضيف Paseo غير متاح.",
      loadBeforeWrite: "حمّل دفتر الملاحظات قبل الكتابة فيه.",
      conflict: "تغيّر دفتر الملاحظات في مكان آخر. تم تحديثه؛ حاول مرة أخرى.",
    },
  },
  sessions: {
    title: "السجل",
