...
export const fr: TranslationResources = {
  ...
  agentPanel: {
    stream: {
      tab: "Fil",
      title: "Au fil de ce chat",
      description: "Questions, décisions, réponses et fichiers. Les plus récents en premier.",
      ...
      pending: "Réponse attendue ({{count}})",
      noPending: "Aucune réponse attendue",
      noPendingDescription: "Les anciennes questions et les résultats restent dans le fil complet.",
      emptyTitle: "Le fil qui accompagne votre chat",
      emptyDescription:
        "Questions, autorisations et réponses finales apparaîtront ici pendant le travail de l’agent.",
      backToChat: "Retour au chat",
      retention:
        "Les 50 derniers moments et les fichiers collectés. La capture commence avec la mise à jour de l’hôte ; le contexte complet reste dans Chat.",
      question: "Question",
      decision: "Décision",
      permission: "Demande d’autorisation",
      open: "En attente de réponse",
      reply_sent: "Réponse envoyée · décision non vérifiée",
      pendingStatus: "En attente de votre réponse",
      allowed: "Réponse acceptée",
      denied: "Refusée",
      expired: "Plus en attente",
      completed: "Tour terminé",
      failed: "Échec du tour",
      canceled: "Interrompu",
      outcomeDescription: "L’état décrit le tour, sans vérifier la réussite de la tâche.",
      excerpt: "Extrait. Le contexte complet est dans Chat.",
      showLess: "Réduire",
      read: "Lire",
