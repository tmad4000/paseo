...
export const fr: TranslationResources = {
  ...
  workNotebook: {
    title: "Carnet",
    openBesideAccessibility: "Ouvrir le carnet de travail à côté de cette discussion",
    descriptor: {
      session: "Carnet de session",
      sessionWithTitle: "{{title}} · carnet de session",
      tooltip: "Carnet de travail",
      tooltipWithTitle: "Carnet de travail de {{title}}",
    },
    eyebrow: "CARNET DE SESSION",
    intro: "La marge de travail persistante de cette discussion.",
    loading: "Chargement du flux de travail…",
    refresh: "Actualiser",
    unavailable: {
      title: "Carnet indisponible",
      updateHostTitle: "Les carnets de travail nécessitent un hôte plus récent",
      updateHostDescription:
        "Mettez à jour puis reconnectez le daemon Paseo pour utiliser le carnet à côté de cette discussion.",
      connecting: "Connexion à l’hôte Paseo…",
      reconnect: "Reconnectez l’hôte Paseo pour charger le carnet de cette session.",
    },
    notices: {
      reconnecting:
        "Les données enregistrées du carnet sont affichées pendant la reconnexion de l’hôte.",
      archivedReadOnly: "Cet agent est archivé. Son carnet est disponible en lecture seule.",
    },
    sections: {
      pinned: "Épinglé",
    ...
    empty: {
      pinned: "Épinglez une note ou une question pour la garder visible.",
      openQuestions: "Les questions restent ici jusqu’à leur résolution.",
      streamTitle: "Une marge de travail dégagée",
      streamDescription:
        "Ajoutez une note ou une question ci-dessous. Chaque changement reste dans ce flux.",
    },
    eventCount: "{{count}} événements",
    composer: {
      note: "Note",
      question: "Question",
      notePlaceholder: "Conservez une note dans le flux de travail…",
      questionPlaceholder: "Qu’est-ce qui attend encore une réponse ?",
      noteAccessibility: "Nouvelle note du carnet",
      questionAccessibility: "Nouvelle question du carnet",
      add: "Ajouter",
    },
    status: {
    ...
    events: {
      note: "Note",
      questionOpened: "Question ouverte",
      questionResolved: "Question résolue",
      questionReopened: "Question rouverte",
      itemPinned: "Élément épinglé",
      itemUnpinned: "Élément désépinglé",
      referencedItem: "Élément référencé",
      linkCaptured: "Lien capturé",
      artifactObserved: "Artefact observé",
    },
    authors: {
      agent: "Agent",
      system: "Paseo",
    ...
    errors: {
      loadTitle: "Impossible de charger le carnet",
      incompleteTitle: "Le flux du carnet est incomplet",
      inconsistentRevision:
        "Le carnet a changé pendant le chargement. Réessayez pour obtenir un flux cohérent.",
      noProgress: "Le flux du carnet a cessé d’avancer pendant le chargement.",
      incompleteStream: "Le flux complet est requis avant d’afficher ou de modifier le carnet.",
      unknown: "Impossible de charger le carnet. Réessayez.",
      archived: "Les carnets archivés sont en lecture seule.",
      agentNotFound: "L’agent de ce carnet est introuvable.",
      invalidTarget: "Cet élément n’est plus disponible dans l’état attendu.",
      hostUnavailable: "L’hôte Paseo est indisponible.",
      loadBeforeWrite: "Chargez le carnet avant d’y écrire.",
      conflict: "Le carnet a changé ailleurs. Il a été actualisé ; réessayez.",
    },
  },
  sessions: {
    title: "Historique",
