...
export const ja: TranslationResources = {
  ...
  workNotebook: {
    title: "ノートブック",
    openBesideAccessibility: "このチャットの横に作業ノートブックを開く",
    descriptor: {
      session: "セッションノートブック",
      sessionWithTitle: "{{title}} · セッションノートブック",
      tooltip: "作業ノートブック",
      tooltipWithTitle: "{{title}} の作業ノートブック",
    },
    eyebrow: "セッションノートブック",
    intro: "このチャットに紐づく永続的な作業スペースです。",
    loading: "作業ストリームを読み込んでいます…",
    refresh: "更新",
    unavailable: {
      title: "ノートブックを利用できません",
      updateHostTitle: "作業ノートブックには新しいホストが必要です",
      updateHostDescription:
        "このチャットの横でノートブックを使うには、Paseo デーモンを更新して再接続してください。",
      connecting: "Paseo ホストに接続しています…",
      reconnect: "このセッションのノートブックを読み込むには Paseo ホストに再接続してください。",
    },
    notices: {
      reconnecting: "ホストの再接続中は保存済みのノートブックデータを表示しています。",
      archivedReadOnly: "このエージェントはアーカイブ済みです。ノートブックは読み取り専用です。",
    },
    sections: {
      pinned: "ピン留め",
    ...
    empty: {
      pinned: "メモや質問をピン留めして見える場所に残せます。",
      openQuestions: "質問は解決するまでここに残ります。",
      streamTitle: "すっきりした作業スペース",
      streamDescription: "下からメモや質問を追加できます。すべての変更がこのストリームに残ります。",
    },
    eventCount: "{{count}} 件のイベント",
    composer: {
      note: "メモ",
      question: "質問",
      notePlaceholder: "作業ストリームにメモを残す…",
      questionPlaceholder: "まだ答えが必要なことは？",
      noteAccessibility: "新しいノートブックメモ",
      questionAccessibility: "新しいノートブック質問",
      add: "追加",
    },
    status: {
      noteAdded: "メモを追加しました",
      questionAdded: "質問を追加しました",
      updated: "ノートブックを更新しました",
    },
    actions: {
      pin: "ピン留め",
      unpin: "ピン留め解除",
      resolve: "解決",
      reopen: "再開",
      openLink: "リンク {{url}} を開く",
      openArtifact: "開く",
    },
    events: {
      note: "メモ",
      questionOpened: "質問を開始",
      questionResolved: "質問を解決",
      questionReopened: "質問を再開",
      itemPinned: "項目をピン留め",
      itemUnpinned: "項目のピン留めを解除",
      referencedItem: "参照項目",
      linkCaptured: "リンクを取得",
      artifactObserved: "成果物を検出",
    },
    authors: {
      agent: "エージェント",
      system: "Paseo",
    ...
    errors: {
      loadTitle: "ノートブックを読み込めませんでした",
      incompleteTitle: "ノートブックのストリームが不完全です",
      inconsistentRevision: "読み込み中にノートブックが変更されました。再試行してください。",
      noProgress: "読み込み中にノートブックのストリームが進まなくなりました。",
      incompleteStream: "表示や編集を行う前に完全なストリームを読み込む必要があります。",
      unknown: "ノートブックを読み込めませんでした。もう一度お試しください。",
      archived: "アーカイブ済みノートブックは読み取り専用です。",
      agentNotFound: "このノートブックのエージェントが見つかりません。",
      invalidTarget: "その項目は想定された状態では利用できなくなりました。",
      hostUnavailable: "Paseo ホストを利用できません。",
      loadBeforeWrite: "書き込む前にノートブックを読み込んでください。",
      conflict: "別の場所でノートブックが変更されました。更新したので再試行してください。",
    },
  },
  sessions: {
    title: "履歴",
