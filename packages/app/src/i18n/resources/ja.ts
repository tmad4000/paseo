...
export const ja: TranslationResources = {
  ...
  agentPanel: {
    stream: {
      ...
      showAll: "すべて表示",
      pending: "返信が必要（{{count}}）",
      noPending: "返信待ちはありません",
      noPendingDescription: "過去の質問と結果はストリーム全体で確認できます。",
      emptyTitle: "チャットに寄り添うストリーム",
      emptyDescription: "エージェントの作業中に質問、承認、最終回答がここに表示されます。",
      backToChat: "チャットに戻る",
      retention:
        "直近50件と収集されたファイル。ホスト更新後から記録されます。全文はチャットで確認できます。",
      question: "質問",
      decision: "判断",
      permission: "許可のリクエスト",
      open: "返信待ち",
      reply_sent: "返信済み・判断は未確認",
      pendingStatus: "あなたの回答待ち",
      allowed: "回答を受け付けました",
      denied: "拒否済み",
      expired: "保留ではありません",
      completed: "ターン終了",
      failed: "ターン失敗",
      canceled: "中断",
      outcomeDescription: "実行状態はターンの状態であり、タスクの達成を保証しません。",
      excerpt: "抜粋です。全文はチャットで確認できます。",
      showLess: "閉じる",
      read: "読む",
      replyInChat: "チャットで返信",
      viewStream: "ストリームを表示",
